...
def stringToMp3(strings_txt):
    strings_txt = '起床呀~懒虫~起床啊~起床啦~要上班啦！' + strings_txt
    APPID = '11696950'
    APIKey = 'gegqmCQlf1tGUzVwWml5MM32'
    SecretKey = '**************************'
...
def main():
    # 获取需要转换语音的文字
    text_string = get_weather()
    print(text_string)
    # 获取音乐文件绝对地址
    mp3path2 = os.path.join(os.path.dirname(__file__), '4948.wav')
    # 先播放一首音乐做闹钟
    os.system('mplayer %s' % mp3path2)
    # 播报语音天气
    stringToMp3(text_string)
